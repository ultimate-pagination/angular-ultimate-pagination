...
gulp.task('clean:dist', function () {
  ...
  return deleteFolders([distFolder + '/**', '!' + distFolder, '!' + distFolder + '/node_modules', '!' + distFolder + '/node_modules/**/*']);
});
...
gulp.task('rollup:fesm', function () {
  ...
  // transform the files here.
    .pipe(rollup({
      ...
      entry: `${buildFolder}/angular-ultimate-pagination.js`,
...
gulp.task('rollup:umd', function () {
  ...
  // transform the files here.
    .pipe(rollup({
      ...
      moduleName: 'angular-ultimate-pagination',
    ...
    .pipe(rename('angular-ultimate-pagination.umd.js'))
    .pipe(gulp.dest(distFolder));
});
